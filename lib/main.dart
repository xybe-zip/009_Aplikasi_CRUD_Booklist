...
class _MyHomePageState extends State<MyHomePage> {
  ...
  TextEditingController thickController = TextEditingController();
  ...
  Future<void> addBook() async {
    await SQLHelper.addBook(titleController.text, authorController.text, publisherController.text,
        yearController.text, thickController.text);
    refreshBooks();
  }

  // Function -> Update
  Future<void> updateBooks(int id) async {
    await SQLHelper.updateBooks(id, titleController.text, authorController.text, publisherController.text,
        yearController.text, thickController.text);
    refreshBooks();
  }
  ...
  void modalForm(int id) async {
    if (id != null) {
      ...
      publisherController.text = dataBooks['publisher'];
      yearController.text = dataBooks['year'];
      thickController.text = dataBooks['thick'];
    }
